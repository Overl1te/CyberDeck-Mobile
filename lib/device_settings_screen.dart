          ...
          : ListView(
              ...
              children: [
                    ...
                    children: [
                      _sliderRow(
                        ...
                        onChanged: (v) => setState(
                            () => _s = _s.copyWith(touchSensitivity: v)),
                      ),
                      ...
                      _sliderRow(
                        ...
                        onChanged: (v) =>
                            setState(() => _s = _s.copyWith(scrollFactor: v)),
                      ),
                      const SizedBox(height: 8),
                      SwitchListTile(
                        value: _s.haptics,
                        onChanged: (v) =>
                            setState(() => _s = _s.copyWith(haptics: v)),
                        title: const Text(
                            '\u0412\u0438\u0431\u0440\u043e\u043e\u0442\u043a\u043b\u0438\u043a'),
                        subtitle: const Text(
                  ...
                  child: Column(
                    children: [
                      SwitchListTile(
                        ...
                        onChanged: (v) => setState(
                            () => _s = _s.copyWith(confirmDownloads: v)),
                        title: const Text(
                            '\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0430\u0442\u044c \u0441\u043a\u0430\u0447\u0438\u0432\u0430\u043d\u0438\u0435'),
                        subtitle: const Text(
                            '\u0421\u043f\u0440\u0430\u0448\u0438\u0432\u0430\u0442\u044c \u043f\u0435\u0440\u0435\u0434 \u0441\u043a\u0430\u0447\u0438\u0432\u0430\u043d\u0438\u0435\u043c \u0441 \u041f\u041a',
                            style: TextStyle(color: Colors.grey)),
                        activeThumbColor: kAccentColor,
                      ),
                      SwitchListTile(
                        ...
                        onChanged: (v) => setState(
                            () => _s = _s.copyWith(browserFallback: v)),
                        title: const Text(
                            '\u041e\u0442\u043a\u0440\u044b\u0432\u0430\u0442\u044c \u0432 \u0431\u0440\u0430\u0443\u0437\u0435\u0440\u0435'),
                        subtitle: const Text(
                            '\u0415\u0441\u043b\u0438 \u043f\u0440\u0430\u0432\u0430 \u043d\u0430 \u043f\u0430\u043c\u044f\u0442\u044c \u043d\u0435 \u0434\u0430\u043b\u0438, \u043e\u0442\u043a\u0440\u044b\u0442\u044c \u0441\u0441\u044b\u043b\u043a\u0443 \u0432 \u0431\u0440\u0430\u0443\u0437\u0435\u0440\u0435',
                            style: TextStyle(color: Colors.grey)),
                        activeThumbColor: kAccentColor,
                      ),
                      ListTile(
                        title: const Text(
                            '\u0420\u0435\u0436\u0438\u043c \u043f\u0435\u0440\u0435\u0434\u0430\u0447\u0438'),
                        subtitle: const Text(
                            '\u0421\u043a\u043e\u0440\u043e\u0441\u0442\u044c / \u0431\u0430\u043b\u0430\u043d\u0441 / \u043a\u0430\u0447\u0435\u0441\u0442\u0432\u043e \u043f\u0440\u0438 \u0441\u0435\u0442\u0435\u0432\u044b\u0445 \u0441\u0431\u043e\u044f\u0445',
                            style: TextStyle(color: Colors.grey)),
                ...
                _card(
                  child: ListTile(
                    leading:
                        const Icon(Icons.info_outline, color: kAccentColor),
                    title: const Text(
                        '\u0414\u0430\u043d\u043d\u044b\u0435 \u043f\u043e\u0434\u043a\u043b\u044e\u0447\u0435\u043d\u0438\u044f'),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _slider(
                        ...
                        onChanged: (v) => setState(
                            () => _s = _s.copyWith(streamMaxWidth: v.toInt())),
                      ),
                      _slider(
                        label:
                            '\u041a\u0430\u0447\u0435\u0441\u0442\u0432\u043e JPEG',
                        ...
                        format: (v) => v.toInt().toString(),
                        onChanged: (v) => setState(
                            () => _s = _s.copyWith(streamQuality: v.toInt())),
                      ),
                      _slider(
                        label: 'FPS',
                        ...
                        format: (v) => v.toInt().toString(),
                        onChanged: (v) => setState(
                            () => _s = _s.copyWith(streamFps: v.toInt())),
                      ),
                      SwitchListTile(
                        value: _s.showCursor,
                        onChanged: (v) =>
                            setState(() => _s = _s.copyWith(showCursor: v)),
                        title: const Text(
                            '\u041f\u043e\u043a\u0430\u0437\u044b\u0432\u0430\u0442\u044c \u043a\u0443\u0440\u0441\u043e\u0440'),
                        subtitle: const Text(
                            '\u0414\u043e\u0431\u0430\u0432\u043b\u044f\u0435\u0442 \u043e\u0432\u0435\u0440\u043b\u0435\u0439 \u043a\u0443\u0440\u0441\u043e\u0440\u0430 \u043f\u043e\u0432\u0435\u0440\u0445 \u043f\u043e\u0442\u043e\u043a\u0430',
                            style: TextStyle(color: Colors.grey)),
                        activeThumbColor: kAccentColor,
                      ),
                      SwitchListTile(
                        value: _s.lowLatency,
                        onChanged: (v) =>
                            setState(() => _s = _s.copyWith(lowLatency: v)),
                        title: const Text(
                            '\u041d\u0438\u0437\u043a\u0430\u044f \u0437\u0430\u0434\u0435\u0440\u0436\u043a\u0430'),
                        subtitle: const Text(
                            '\u0410\u0433\u0440\u0435\u0441\u0441\u0438\u0432\u043d\u043e \u043f\u0440\u043e\u043f\u0443\u0441\u043a\u0430\u0442\u044c \u043a\u0430\u0434\u0440\u044b, \u0447\u0442\u043e\u0431\u044b \u043d\u0435 \u043a\u043e\u043f\u0438\u0442\u044c \u043b\u0430\u0433',
                            style: TextStyle(color: Colors.grey)),
                        activeThumbColor: kAccentColor,
                      ),
                    ],
